    ...
    return (
        <div className="max-w-screen-xl mx-auto">
             <div className=' items-center justify-around flex my-[80px]'>
                <p className='text-center text-[40px] mt-[50px] border-b-4 border-[#411900] font-b text-[#411900]'>Our Reviews</p>
            </div>
...
<div className="flex justify-center items-center ">
        ...
        <div className="bg-gradient-to-b from-[#DAA06D]  ... mx-[50px] my-[100px] text-center flex flex-col items-center  w-[300px] h-[350px] glass">
...
/>
  ...
  className="mx-auto my-[20px]"
    ...
    <p className="text-[16px] text-black mx-[10px] text-left">{review.details}</p>
      ...
      <p className="text-[#CD7F32] text-[70px] uppercase font-a text-center">Cake & Bake Collection</p>
      </div>
        </div>
    );
};
