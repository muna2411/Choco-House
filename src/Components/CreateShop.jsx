...
const CreateShop = () => {
    ...
    return (
      <div>
      <Helmet>
      <title>Choco House | CreateShop</title>
  </Helmet>
  ...
  <div >
    ...
    <form onSubmit={handleAddBook} className="grid lg:grid-cols-2 sm:grid-cols-1 lg:m-[50px] sm:m-[10px]">
              ...
              <div className="form-control m-[20px] lg:w-[500px] sm:w-[500px]">
                <label className="label">
                  <span className="label-text text-[20px] text-[#411900] font-semibold">Shop Owner Name</span>
                </label>
              ...
              <div className="form-control m-[20px] lg:w-[500px] sm:w-[500px]">
                <label className="label">
                  <span className="label-text text-[20px] text-[#411900] font-semibold">Shop Owner Email</span>
                </label>
              ...
              <div className="form-control m-[20px] lg:w-[500px] sm:w-[500px]">
                <label className="label">
                  <span className="label-text text-[20px] text-[#411900] font-semibold">Shop Location</span>
                </label>
              ...
              <div className="form-control m-[20px] lg:w-[500px] sm:w-[500px]">
                <label className="label">
                  <span className="label-text text-[20px] text-[#411900] font-semibold">Shop Info</span>
                </label>
              ...
              <div className="form-control m-[20px] lg:w-[500px] sm:w-[500px]">
                <label className="label">
                  <span className="label-text text-[20px] text-[#411900] font-semibold">Logo / Image</span>
                </label>
